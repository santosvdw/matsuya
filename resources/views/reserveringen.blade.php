...
<html lang="nl">
    <head>
        ...
        <link rel="stylesheet" href="https://matsuya.nl/build/assets/admin-0c9c1569.css">
        <script type="module" src="https://matsuya.nl/build/assets/reserveringen.js"></script>
    </head>
    <body>
        @if (session('status'))
            <div class="alert">
        ...
        <main class="reserveringen">
            ...
            <table>
                ...
                <tr class="huidig">
                    ...
                    <td><a href="/reservering/{{$reservering->id}}"><i class="bi bi-pencil-fill"></i></a></td>
                </tr>
                @endforeach
